...
<div align="center" >
    ...
    <table  id="table_id" class="display">
        ...
        <c:forEach var="product" items="${products}">
            <tr>
                <td scope="row"><c:out value="${product.manager_product_id}"/></td>
                <td><c:out value="${product.product_name}"/></td>
                <td><c:out value="${product.product_price}"/></td>
                <td><c:out value="${product.product_discount}"/></td>
                <td><a href="/products?action=edit&id=${product.manager_product_id}">Edit</a></td>
                <td><a href="/products?action=delete&id=${product.manager_product_id}">Delete</a></td>
